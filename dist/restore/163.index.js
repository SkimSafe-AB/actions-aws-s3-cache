...
const util_endpoints_1 = __webpack_require__(5105);
const util_endpoints_2 = __webpack_require__(2313);
const ruleset_1 = __webpack_require__(3811);
...
var middlewareRecursionDetection = __webpack_require__(3379);
...
var httpAuthSchemeProvider = __webpack_require__(84);
var runtimeConfig = __webpack_require__(2637);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(162));
const core_1 = __webpack_require__(7206);
...
const runtimeConfig_shared_1 = __webpack_require__(8098);
...
const httpAuthSchemeProvider_1 = __webpack_require__(84);
const endpointResolver_1 = __webpack_require__(6714);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(2654);
var tokenProviders = __webpack_require__(2647);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(1730); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(779);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 9).then(__webpack_require__.t.bind(__webpack_require__, 9, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 9).then(__webpack_require__.t.bind(__webpack_require__, 9, 19));
